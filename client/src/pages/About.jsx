    ...
    <div className='bg-cover bg-center h-[410px] sm:h-[500px]'>
     <div className='py-10 px-4 mt-5 max-w-5xl mx-auto relative'>
      ...
      <p className='mb-4 text-slate-700'>
        At HARS Estate, we redefine the real estate experience by blending expertise with innovation. Our dedicated team of professionals is committed to delivering unparalleled service, ensuring your journey in the world of real estate is not just successful but also memorable.
      </p>
      <p className='mb-4 text-slate-700'>
        With a deep understanding of the ever-evolving market trends and a passion for excellence, we strive to exceed your expectations at every turn. Whether you're searching for your dream home, looking to sell your property, or seeking expert guidance in investment opportunities, HARS Estate is your trusted partner every step of the way.
      </p>
      <p className='mb-4 text-slate-700'>
        Experience the difference with HARS Estate – where integrity, innovation, and inspiration converge to create extraordinary real estate experiences.
      </p>
